    ...
    for img_name in file_list_img:
        ...
        for partition in [2,3,4,5,6,7]:
            ...
            for e,i in enumerate(split_list):
                ...
                di =  "/home/ubuntu/superpixel-benchmark/data/BSDS500/disjoint/"+str(numSegments)+"/"+str(partition)
                save = "/home/ubuntu/superpixel-benchmark/data/BSDS500/disjoint/"+str(numSegments)+"/"+str(partition)+"/"+img_name[:-4]+"_"+str(e)+".jpg"
